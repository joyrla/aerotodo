        ...
        <div className="hidden md:flex flex-col w-full h-full">
          ...
          <div className="flex items-center gap-2 px-6 pb-5 flex-wrap">
            ...
            <Popover open={showDatePicker} onOpenChange={setShowDatePicker}>
              <PopoverTrigger asChild>
                <button className={cn(
                  "inline-flex items-center gap-1.5 h-8 px-3 rounded-lg text-xs font-mono transition-all border",
                  task.date 
            ...
            <Popover>
              <PopoverTrigger asChild>
                <button className={cn(
                  "inline-flex items-center gap-1.5 h-8 px-3 rounded-lg text-xs font-mono transition-all border whitespace-nowrap",
                  task.timeSlot 
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 h-8 px-3 rounded-lg text-xs font-mono border border-transparent bg-muted/40 text-muted-foreground/50 hover:bg-muted/60 hover:text-muted-foreground transition-colors"
            ...
            <button
              ...
              disabled={isSyncingToGcal}
              className={cn(
                "inline-flex items-center gap-1.5 h-8 px-3 rounded-lg text-xs font-mono border border-transparent transition-colors",
                task.googleCalendarEventId
