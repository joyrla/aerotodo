    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          mobileSheet && mobilePosition === "top" && "inset-x-0 top-0 rounded-b-lg md:inset-auto md:top-auto md:rounded-lg",
          ...
          mobileSheet && mobilePosition === "bottom" && "inset-x-0 bottom-0 rounded-t-lg md:inset-auto md:bottom-auto md:rounded-lg",
