...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-lg bg-muted/60 backdrop-blur-sm p-1 text-muted-foreground gap-1 relative border border-border/40",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=inactive]:text-muted-foreground data-[state=inactive]:hover:bg-accent/40",
